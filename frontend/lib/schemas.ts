...
export const chatSchema = z.object({ id: z.string(), workspace_id: z.string(), user_id: z.string().nullable().optional(), title: z.string().nullable().optional(), status: z.string().default("active"), mode: z.string().default("ai"), assigned_to: z.string().nullable().optional(), created_at: z.string().nullable().optional(), updated_at: z.string().nullable().optional() });
...
export const tagSchema = z.object({ id: z.string(), workspace_id: z.string(), name: z.string(), color: z.string().default("#6366f1"), created_at: z.string().nullable().optional(), updated_at: z.string().nullable().optional() });
export const chatWithMessagesSchema = chatSchema.extend({ messages: z.array(messageSchema).default([]), tags: z.array(tagSchema).default([]) });
...
export type ChatTag = z.infer<typeof tagSchema>;
